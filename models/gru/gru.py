...
def gru_actor(cfg, action_spec, in_keys=None, out_keys=None):
    """
    ...
    actor_module = TensorDictSequential(mlp_observation_residual, feature_for_lstm, gru, final_mlp)
...
def gru_critic(cfg, in_keys=None, out_keys=None):
